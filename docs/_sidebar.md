...
- 📚 篇章四：pi-tui 终端 UI
  ...
  - [1. 核心概念](/pi-mono-tutorial/4_pi_tui/01-core-concepts.md)
  - [2. 差分渲染](/pi-mono-tutorial/4_pi_tui/02-differential-rendering.md)
  - [3. 组件系统](/pi-mono-tutorial/4_pi_tui/03-component-system.md)
  - [4. 覆盖层与焦点管理](/pi-mono-tutorial/4_pi_tui/04-overlays-focus.md)
  - [5. 键盘输入](/pi-mono-tutorial/4_pi_tui/05-keyboard-input.md)
  - [6. 高级模式](/pi-mono-tutorial/4_pi_tui/06-advanced-patterns.md)

- 📚 篇章五：pi-coding-agent 编码 Agent
  - [0. 快速开始](/pi-mono-tutorial/5_pi_coding_agent/00-README-zh.md)
...
- 📚 篇章六：pi-web-ui Web 组件
  ...
  - [1. 核心概念](/pi-mono-tutorial/6_pi_web_ui/01-core-concepts.md)
  - [2. 组件架构](/pi-mono-tutorial/6_pi_web_ui/02-component-architecture.md)
  - [3. 样式与主题](/pi-mono-tutorial/6_pi_web_ui/03-styling-theming.md)
